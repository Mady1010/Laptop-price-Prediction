...
os_type = st.selectbox('Operating System', ['Windows', 'DOS', 'MacOS'])
cpu_model = st.selectbox('CPU Model', ['Intel', 'AMD', 'M'])
gpu_brand = st.selectbox('GPU Brand', ['NVIDIA', 'AMD', 'Intel','Apple'])
gpu_memory = st.selectbox('GPU Memory (for apple gpu)', [10, 14, 18, 30])
